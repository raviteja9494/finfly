...
sealed interface AppRoute {
    ...
    @Serializable data class AccountEditor(val accountId: String? = null) : AppRoute
    @Serializable data class FeatureList(val feature: com.teja.finflyiii.domain.model.FireflyFeature) : AppRoute
    @Serializable data class FeatureEditor(
        val feature: com.teja.finflyiii.domain.model.FireflyFeature,
