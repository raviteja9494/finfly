...
object RagPromptBuilder {
    fun build(
        ...
        val text = buildString {
            ...
            appendLine("When listing transactions, write: Merchant — amount currency (category, payment method).")
            appendLine("Do not show raw tags, account-routing labels, or unnecessary trailing zeroes.")
            appendLine("Omit the date when every listed transaction is from the single day the user requested.")
